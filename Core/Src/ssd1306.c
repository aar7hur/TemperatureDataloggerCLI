...
void print_temperature(char *print_value){
	...
	SSD1306_Puts (print_value, &Font_16x26,1);
...
void print_OK(char * print_value)
{
	...
	SSD1306_GotoXY(0,10);
	SSD1306_Puts("Conexao OK!:", &Font_11x18,1);
	SSD1306_GotoXY (00,35);
	SSD1306_Puts (print_value, &Font_11x18,1);
